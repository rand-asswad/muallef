...
\bibitem{peaks}
Carlos Rosão, Ricardo Ribeiro, et David Martins de Matos.\\
\textit{Influence of peak selection methods on onset detection}, 2012.

\bibitem{onset-complex}
Chris Duxbury, Juan Pablo Bello, Mike Davies and Mark Sandler.\\
\textit{Complex domain onset detection for musical signals}, 2003.
